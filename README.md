...
| **[GUIDE.md](./GUIDE.md)** | **High-Level Progression Guide & Compendium**: Macro progression phases (Phases 1–4 without spoilers), clinical biome geometry matrix, beginner survival wisdom & pro strategies, transition criteria, and official dev news links. | Static reference updated for new game updates. |
| **[TODO.md](./TODO.md)** | **Immediate Action Roadmap**: Actionable pending checklists sequenced for efficient geographic sweeps (crafting milestones, essential gear tips, shopping lists, and systematic exploration verification SOPs). | Updated as items are completed in-game. |
